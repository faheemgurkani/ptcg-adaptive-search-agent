...
| [Phase 3 — Ablation](phase_03/README.md) (**complete**) | V1–V4 search × adaptation matrix | [Holdout log](phase_03/offline/HOLDOUT_LOG.md) | [Completion](phase_03/PHASE_03_COMPLETION.md) |
| Phase 4 | Search depth sweeps | *(pending)* | *(pending)* |
